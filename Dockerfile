...
ENV DB_HOST=""
ENV DB_PORT="3306"
ENV CONSOLE="/code/bin/console"
ARG DEBIAN_FRONTEND="noninteractive"

RUN apt-get update; \
    apt-get install -y --no-install-recommends sudo wget netcat libcurl4-openssl-dev curl git unzip libzip-dev zlib1g-dev libpng-dev apt-utils; \
...
RUN chmod 0777 /code/bin/*

USER www-data

#CMD ["/opt/php/fpm.sh"]
#CMD ["/code/docker/php/fpm.sh"]
